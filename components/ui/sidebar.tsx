...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute right-[-4px] bottom-4 z-[100] h-6 w-6 rounded-lg border bg-background shadow-sm",
